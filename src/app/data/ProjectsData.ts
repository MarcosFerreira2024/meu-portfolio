...
O layout é limpo, responsivo e pensado para facilitar a navegação e visualização de informações de maneira prática.`,
    ...
    {
        id: 7,
        img: '/projetos/calculadora.png',
        title: 'Calculadora IMC',
        text: `A Calculadora de IMC é um projeto web desenvolvido com TypeScript, Tailwind, HTML e JavaScript,
    ...
    {
        id: 8,
        img: '/projetos/pokedex.png',
        title: 'Pokédex',
        text: `A Pokédex é um projeto web interativo criado para listar, 
        pesquisar e visualizar informações sobre Pokémons de forma rápida e intuitiva. 
        Desenvolvida com HTML, CSS3 e JavaScript, a plataforma conecta-se a uma 
        API pública de Pokémons para trazer 
