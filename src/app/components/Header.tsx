...
function Header() {
  ...
  return (
    <header className="flex flex-col w-full justify-center items-center text-center pt-5 border-b-2 border-main relative">
      ...
      <h1 className="md:text-gg text-4xl text-main-contrast ">
      ...
      <Image
        ...
        src="/icons/wave.svg"
        className="duration-300 ease-in-out hover:rotate-12 absolute right-2 top-2  max-w-[24px] md:max-w-[48px] cursor-not-allowed"
